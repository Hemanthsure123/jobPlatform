...
const FiltersGroup = props => {
  ...
  const locationBasedFilter = () => {
    const {locationBasedList} = props
    return (
      <div className="employment-type-container">
        <h1 className="employment-type-heading">Location</h1>
        <ul className="employee-type-list-container">
          {locationBasedList.map(eachEmployeeType => (
            <li className="employee-item" key={eachEmployeeType.locationId}>
              <input
                type="checkbox"
                id={eachEmployeeType.locationId}
                className="check-input"
                value={eachEmployeeType.locationId}
                onChange={onSelectLocationType}
              />
              <label
                htmlFor={eachEmployeeType.locationId}
                className="check-label"
              >
                {eachEmployeeType.label}
              </label>
